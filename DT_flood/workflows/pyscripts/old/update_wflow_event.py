...
print(
    f"Configuring WFlow event run for FloodAdapt Database {fa_database_fn.stem} with scenario {argv[2]}"
)
...
endtime = datetime.strptime(
    scenario.direct_impacts.hazard.event.attrs.time.end_time, "%Y%m%d %H%M%S"
)
