...
sf = SfincsModel(root=sfincs_out_path, mode="r")
sf.read()
...
flow_bounds = read_astro_boundary_conditions(
    flow_boundary_point=flow_bounds, bca_fn=Path(sf.root) / f"tide_{tidemodel}.bc"
)
